...
<DocFigure
  placeholder="待补：endpoint show、policy show 与 endpoint test 的三段脱敏输出"
  assetName="/assets/docs/endpoint-diagnostics.webp"
  caption="截图应保留 route 类型和连接阶段，隐藏主机名、设备 ID、指纹、地址和 credential reference。"
/>
