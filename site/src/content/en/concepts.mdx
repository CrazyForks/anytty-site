...
| Android | signed Beta APKs on GitHub Releases | terminals, pairing, and files |
| iOS / iPadOS | [public TestFlight beta](https://testflight.apple.com/join/rfcgFyJh), iOS 15+ | terminals, pairing, files, tablet workflows |
