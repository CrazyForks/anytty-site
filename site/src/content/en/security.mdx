...
<DocFigure
  src="/assets/docs/security-boundary.webp"
  alt="Trust boundary diagram separating client reachability from endpoint daemon authorization"
  caption="Routes establish reachability; the endpoint daemon remains the authorization authority."
  width={1440}
  height={810}
/>
