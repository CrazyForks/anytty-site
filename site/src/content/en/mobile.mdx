...
Android is available as a Beta APK; the current release APK is unsigned. iOS/iPadOS requires iOS 15 or later and is available through the [public TestFlight beta](https://testflight.apple.com/join/rfcgFyJh). New testers can install the current build after Apple Beta App Review is complete.
...
<DocFigure
  ...
  alt="AnyTTY terminal on a phone"
  caption="The mobile terminal combines the live session with controls suited to touch input."
  width={480}
  height={1068}
  portrait
  contain
