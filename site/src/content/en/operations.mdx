...
<DocFigure
  placeholder="Needed: redacted daemon status, doctor, and logs screenshot"
  assetName="/assets/docs/daemon-operations.webp"
  caption="Capture with a fresh test user and local endpoint so no real identity or path is exposed."
/>
