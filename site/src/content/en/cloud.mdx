...
<DocFigure
  placeholder="Needed: Cloud daemon registration and enrollment command flow"
  assetName="/assets/docs/cloud-enrollment.webp"
  caption="Capture with a disposable account and redact tokens, daemon identity, region, and account details."
/>
