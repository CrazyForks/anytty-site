...
<DocFigure
  placeholder="Needed: endpoint show and route test diagnostics with test identities"
  assetName="/assets/docs/endpoint-diagnostics.webp"
  caption="Redact hostnames, addresses, fingerprints, usernames, and credential references."
/>
